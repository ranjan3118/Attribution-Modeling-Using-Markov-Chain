...
channel = read.csv("C:/Users/ayush/OneDrive/Desktop/Channel_attribution.csv", header = T)
head(channel)
...
R1 <- R[,c('channel_name', 'first_touch_conversions', 'last_touch_conversions', 'linear_touch_conversions', 'total_conversion')]
...
knitr::include_graphics("C:\\CAEA\\R working directory\\Attribution Modeling.png")
